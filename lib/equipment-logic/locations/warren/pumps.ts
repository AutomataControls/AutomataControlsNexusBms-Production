 ...
 */
export function pumpControl(metrics: any, settings: any, currentTemp: number, stateStorage: any): any {
  ...
  logLocationEquipment(locationId, equipmentId, "pump", "Starting Warren-specific pump control logic");
  ...
  if (pumpType !== "HWPump") {
    ...
    return pumpControlBase(metrics, settings, currentTemp, stateStorage);
  }
