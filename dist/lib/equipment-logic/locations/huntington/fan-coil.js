...
function fanCoilControl(metrics, settings, currentTemp, pidState) {
    ...
    (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", "Starting Huntington-specific fan coil control logic");
    ...
    (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `DEBUG - Raw metrics: ${JSON.stringify(metrics)}`);
    ...
    (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `FULL SETTINGS: ${JSON.stringify(settings)}`);
    // Log what user settings were found
    (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `USER SETTINGS FOUND: ${JSON.stringify(userControlsFromUI, (k, v) => v === undefined ? "N/A" : v)}`);
    ...
    if (((_a = settings.outdoorAirReset) === null || _a === void 0 ? void 0 : _a.enabled) !== false) {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `OAR calculation: Outdoor temp ${outdoorTemp}°F -> OAR setpoint ${oarSetpointValue.toFixed(1)}°F`);
    }
    ...
    if (userControlsFromUI.temperatureSetpoint !== undefined) {
        ...
        setpointSource = "UI";
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `USING UI SETPOINT: ${finalSetpoint}°F - HIGHEST PRIORITY`);
    }
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using database setpoint: ${finalSetpoint}°F - MEDIUM PRIORITY`);
    }
    else {
        // OAR-calculated setpoint has lowest priority (fallback)
        finalSetpoint = oarSetpointValue;
        setpointSource = "OAR";
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using fallback OAR setpoint: ${finalSetpoint.toFixed(1)}°F - LOWEST PRIORITY`);
    }
    // --- Apply unit enable priority ---
    let finalUnitEnable;
    if (userControlsFromUI.unitEnable !== undefined) {
        finalUnitEnable = userControlsFromUI.unitEnable;
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using UI unit enable: ${finalUnitEnable ? "ON" : "OFF"}`);
    }
    else {
    ...
    if (userControlsFromUI.fanEnabled !== undefined) {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using UI fan enable: ${finalFanEnabled ? "ON" : "OFF"}`);
    }
    else {
    ...
    if (userControlsFromUI.fanSpeed !== undefined) {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using UI fan speed: ${finalFanSpeed}`);
    }
    else {
    ...
    if (userControlsFromUI.fanMode !== undefined) {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using UI fan mode: ${finalFanMode}`);
    }
    else {
    ...
    if (userControlsFromUI.operationMode !== undefined) {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using UI operation mode: ${finalOperationMode}`);
    }
    else {
    ...
    if (finalHeatingValveMode === "manual") {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Heating valve in MANUAL mode: Using fixed position ${finalHeatingValvePosition}%`);
    }
    // For cooling valve
    if (finalCoolingValveMode === "manual") {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Cooling valve in MANUAL mode: Using fixed position ${finalCoolingValvePosition}%`);
    }
    ...
    if (currentTemp <= 40) {
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `FREEZESTAT TRIP at ${currentTemp}°F supply`);
        return {
    ...
    if (currentTemp >= 115) {
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `HI-LIMIT TRIP at ${currentTemp}°F supply`);
        return {
    ...
    if (userControlsFromUI.outdoorDamperPosition !== undefined) {
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Using user-defined outdoor damper position: ${outdoorDamperPosition}`);
    }
    // Otherwise use automatic binary control based on outdoor temp
        ...
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Outdoor temp ${outdoorTemp}°F > 40°F, setting damper to OPEN (1)`);
    }
    else {
        (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Outdoor temp ${outdoorTemp}°F <= 40°F, setting damper to CLOSED (0)`);
    }
    ...
    const huntingtonSettings = {
        ...
        pidControllers: {
            cooling: {
                ...
                ...(((_b = settings.pidControllers) === null || _b === void 0 ? void 0 : _b.cooling) || {}),
            ...
            heating: {
                ...
                ...(((_c = settings.pidControllers) === null || _c === void 0 ? void 0 : _c.heating) || {}),
    ...
    (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Calling base implementation with ${setpointSource} setpoint: ${finalSetpoint.toFixed(1)}°F, ` +
    ...
    const baseResult = (0, fan_coil_1.fanCoilControl)(metrics, huntingtonSettings, currentTemp, pidState);
    ...
    (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, "fan-coil", `Control result: Unit=${result.unitEnable ? "ON" : "OFF"}, ` +
