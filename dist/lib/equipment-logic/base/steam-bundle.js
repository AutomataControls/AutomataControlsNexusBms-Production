...
function logEquipment(equipmentId, message, data) {
    ...
    (0, location_logger_1.logLocationEquipment)(locationId, equipmentId, equipmentType, message, data);
}
/**
...
function steamBundleControl(metrics, settings, currentTemp, pidState) {
    ...
    const oarEnabled = ((_a = settings.outdoorAirReset) === null || _a === void 0 ? void 0 : _a.enabled) !== false;
    // OAR configuration with defaults
    const minOAT = ((_b = settings.outdoorAirReset) === null || _b === void 0 ? void 0 : _b.minOutdoorTemp) || 32; // Below this, use max setpoint
    const maxOAT = ((_c = settings.outdoorAirReset) === null || _c === void 0 ? void 0 : _c.maxOutdoorTemp) || 70; // Above this, system off
    const minSetpoint = 0; // Minimum setpoint (system off)
    const maxSetpoint = ((_d = settings.outdoorAirReset) === null || _d === void 0 ? void 0 : _d.maxSetpoint) || 155; // Maximum setpoint at min OAT
    let setpoint = 0;
    ...
    if (error > 0) {
        ...
        const pidParams = {
            kp: ((_f = (_e = settings.pidControllers) === null || _e === void 0 ? void 0 : _e.heating) === null || _f === void 0 ? void 0 : _f.kp) || 2.0, // Proportional gain
            ki: ((_h = (_g = settings.pidControllers) === null || _g === void 0 ? void 0 : _g.heating) === null || _h === void 0 ? void 0 : _h.ki) || 0.1, // Integral gain
            kd: ((_k = (_j = settings.pidControllers) === null || _j === void 0 ? void 0 : _j.heating) === null || _k === void 0 ? void 0 : _k.kd) || 0.1, // Derivative gain
            outputMin: 0, // Minimum output (0%)
            outputMax: 100, // Maximum output (100%)
            enabled: true,
            reverseActing: false, // Direct acting (more output = more heat)
            maxIntegral: ((_m = (_l = settings.pidControllers) === null || _l === void 0 ? void 0 : _l.heating) === null || _m === void 0 ? void 0 : _m.maxIntegral) || 20 // Anti-windup
        };
    ...
    logEquipment(equipmentId, `Final control values: primary valve=${result.primaryValvePosition.toFixed(1)}%, ` +
        ...
        `setpoint=${result.temperatureSetpoint}°F`, result);
    return result;
}
/**
 * Helper function to check for pump operation across various naming conventions
 */
function checkPumpOperation(metrics) {
