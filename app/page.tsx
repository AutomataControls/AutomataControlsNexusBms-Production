...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      <div className="container mx-auto max-w-6xl px-4 flex-1 flex flex-col items-center">
      ...
      <div className="container mx-auto max-w-6xl px-4 bg-transparent relative z-10">
