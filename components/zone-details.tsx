...
import { Building, Settings, ArrowLeft, Fan, AlertTriangle, MapPin, Thermometer, Power, Edit } from "lucide-react"
                ...
                <TabsContent value="controls" className="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            {zone.hasTemperatureControl !== false && (
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Control individual equipment in this zone</CardDescription>
                        </CardHeader>
                        <CardContent>
                            {equipment.length === 0 ? (
                                <div className="flex flex-col items-center justify-center py-6 text-center">
                                    <p className="text-muted-foreground">No equipment available to control</p>
                                </div>
                            ) : (
                                <div className="space-y-4">
                                    {equipment.map((item) => (
